...
class IntroductionPage extends React.Component {
  ...
  componentDidUpdate() {
    ...
    if (wizardCompletionStatus === 'pending') {
      if (
        ...
        this.setEduBenefitFormSelected('app3');
        this.setWizardCompletionStatus('complete');
      } else if (
        (newBenefit === 'no' &&
  ...
  render() {
    ...
    const shouldWizardBeRendered = hasUserLeftLandingPage === 'false';

    const shouldIntroPageBeRendered = hasUserLeftLandingPage === 'true';

    return (
      <div>
        <FormTitle title="Apply Wizards Test App 2" />
        <p>Equal to VA Form (Apply Wizards Test App 2).</p>
