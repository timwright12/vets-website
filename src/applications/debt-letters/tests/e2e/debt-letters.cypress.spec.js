...
describe('Debt Letters', () => {
  ...
  it('C1226 displays the current debts section and navigates to debt details', () => {
  ...
  it('C1227 displays download debt letters', () => {
