...
describe('Diary Codes', () => {
  ...
  it('C1225 renders expected content for diary code: 080', () => {
  ...
  it('C1231 renders expected content for diary code: 100', () => {
    cy.get('[data-testid="diary-codes-status"]').contains(
  ...
  it('C1232 - renders expected content for diary code: 101, 450, 610, 617', () => {
    cy.get('[data-testid="diary-codes-status"]').contains(
  ...
  it('C1233 renders expected content for diary code: 117', () => {
    cy.get('[data-testid="diary-codes-status"]').contains(
      'Status: Pending payment',
    );
  ...
  it('C1234 renders expected content for diary code: 123', () => {
    cy.get('[data-testid="diary-codes-status"]').contains(
      'Status: Pending payment',
    );
  ...
  it('C1235 renders expected content for diary code: 500', () => {
    cy.get('[data-testid="diary-codes-status"]').contains(
  ...
  it('C1236 renders expected content for diary code: 600, 601', () => {
    cy.get('[data-testid="diary-codes-status"]').contains(
      'Status: Pending payment',
    );
